...
const pt = {
  ...
  "settings.delete": "Deletar conta",
  "settings.delete.hint": "Apaga a sessão e o progresso local. Não dá para desfazer neste aparelho.",
...
const en: typeof pt = {
  ...
  "settings.delete.hint": "Removes the session and local progress. This cannot be undone on this device.",
